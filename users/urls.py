...
urlpatterns = [
    ...
    path('<int:id>/autograde-view/', GradeView, name='autograde-view'),
    ...
    path('reassignment_submission/<int:id>', ReAssignmentSubmissionView.as_view(), name='reassignment_submission'),
    path('assignment_submission/<int:id>', AssignmentSubmissionView.as_view(), name='assignment_submission'),
    path('gradeassignment_submission/<int:id>', GradeAssignmentSubmissionView.as_view(), name='gradeassignment_submission'),
    path('assignment-submission-list/<int:id>', AssignmentSubmissionListView.as_view(), name='assignment-submission-list'),
    path('gradeassignment-submission-list/<int:id>', AssignmentSubmissionGradeListView.as_view(), name='gradeassignment-submission-list'),
