...
class AssignmentCreateView(SuccessMessageMixin,CreateView):
    ...
    def form_valid(self, form,request):
        ...
        f='users/media/f/'+form.instance.autograde_script.name
        y=form.instance.autograde_script.name.split(".",1)[0]
        print(y)
        ...
        for x1 in e1:
            ...
            if x1.user==self.request.user:
                ...
                if form.is_valid():
                    ...
                    import os
                    ext = os.path.splitext(form.instance.file.name)[1]
